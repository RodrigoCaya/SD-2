...
var file_dn_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0x24, 0x0a, 0x0c, 0x43, 0x68, 0x75, 0x6e, 0x6b,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x68, 0x75, 0x6e, 0x6b,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x32, 0x50, 0x0a,
	0x0c, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x40, 0x0a,
	0x0d, 0x45, 0x6e, 0x76, 0x69, 0x61, 0x72, 0x5f, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x73, 0x12, 0x16,
	...
	0x6f, 0x2e, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x00, 0x62,
...
var file_dn_proto_depIdxs = []int32{
	1, // 0: dn_proto.ChunkService.Enviar_chunks:input_type -> dn_proto.ChunkRequest
	0, // 1: dn_proto.ChunkService.Enviar_chunks:output_type -> dn_proto.CodeRequest
...
func (c *chunkServiceClient) EnviarChunks(ctx context.Context, in *ChunkRequest, opts ...grpc.CallOption) (*CodeRequest, error) {
	out := new(CodeRequest)
	err := c.cc.Invoke(ctx, "/dn_proto.ChunkService/Enviar_chunks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
