...
var file_nn_proto_rawDesc = []byte{
	,
...
var file_nn_proto_goTypes = []interface{}{
	(*CodeRequest)(nil), // 0: proto.CodeRequest
}
var file_nn_proto_depIdxs = []int32{
	0, // 0: proto.HelloworldService.Buscar:input_type -> proto.CodeRequest
	0, // 1: proto.HelloworldService.Buscar:output_type -> proto.CodeRequest
...
func (c *helloworldServiceClient) Buscar(ctx context.Context, in *CodeRequest, opts ...grpc.CallOption) (*CodeRequest, error) {
	out := new(CodeRequest)
	err := c.cc.Invoke(ctx, "/proto.HelloworldService/Buscar", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloworldService_Buscar_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.HelloworldService/Buscar",
	}
